...
pub struct BreachDepressionsLeastCostParallel {
    name: String,
    description: String,
    toolbox: String,
...
impl BreachDepressionsLeastCostParallel {
    pub fn new() -> BreachDepressionsLeastCostParallel {
        // public constructor
        let name = "BreachDepressionsLeastCostParallel".to_string();
        ...
        BreachDepressionsLeastCostParallel {
            name: name,
...
impl WhiteboxTool for BreachDepressionsLeastCostParallel {
